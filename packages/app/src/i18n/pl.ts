export const dict = {
  ...
  "prompt.placeholder.normal": "Zapytaj o cokolwiek — / dla poleceń, @ dla plików i agentów",
  ...
  "session.tasks.title": "Zadania",
  "command.session.rewind": "Cofnij do tego miejsca",
  "command.transcript.verbosity": "Zmień poziom szczegółów",
  "transcript.verbosity.compact": "Zwięzły",
  "transcript.verbosity.normal": "Normalny",
  "transcript.verbosity.verbose": "Szczegółowy",
  "session.new.shortcuts.more": "Naciśnij {{keybind}}, aby zobaczyć resztę",
  "command.browser.visualEditor": "Otwórz edytor wizualny",
  "command.browser.visualEditor.description": "Sprawdzaj elementy, edytuj style i wskazuj zadania agentowi",
  "github.pr.branchMissing": "Wypchnięto, ale \"{{branch}}\" nie ma w {{repo}} — to repozytorium prawdopodobnie nie jest zdalnym tego katalogu.",
  "github.device.denied": "Autoryzacja GitHub została odrzucona",
  "github.device.expired": "Kod urządzenia wygasł — zacznij od nowa",
  "command.session.follow": "Podążaj za agentem",
  "command.session.follow.on": "Włączone — edytor otwiera każdy plik edytowany przez agenta",
  "command.session.follow.off": "Wyłączone — edytor zostaje tam, gdzie go zostawiłeś",
  "command.browser.designMode": "Przełącz tryb projektowania",
  "command.browser.designMode.on": "Włączone — kliknij elementy, aby je zbadać i edytować",
  "command.browser.designMode.off": "Wyłączone — strona działa normalnie",
  "dialog.analytics.failed": "Nie udało się wczytać danych użycia",
  "dialog.analytics.allTime": "od początku",
  "terminal.sendToChat": "Wyślij wyjście do czatu",
  "terminal.sendToChat.empty": "W terminalu nie ma nic do wysłania",
  "terminal.sendToChat.done": "Wyjście terminala dodane do promptu",
  "terminal.sendToChat.description": "Wysyła zaznaczenie lub ostatnie linie wyjścia do pola wiadomości",
  "session.queue.title": "{{count}} oczekuje na wysłanie",
  "session.queue.steer": "Wyślij teraz, do trwającej tury",
  "session.queue.steered": "Wysłano do trwającej tury",
  "session.queue.steerFailed": "Nie udało się wysłać teraz",
  "session.queue.takeBack": "Wróć nim do pola wiadomości",
  "session.queue.takeBackFailed": "Nie udało się cofnąć — mogło już zostać wysłane",
  "session.queue.takeBackAll": "Cofnij wszystkie",
  "session.queue.takeBackPartial": "Część została już wysłana i nie wróciła",
  "command.session.exportMarkdown": "Skopiuj sesję jako Markdown",
  "command.session.exportMarkdown.description": "Pytania i odpowiedzi, gotowe do wklejenia w zgłoszeniu lub przeglądzie",
  "command.session.exportMarkdown.done": "Skopiowano {{lines}} wierszy",
  "command.session.exportMarkdown.failed": "Nie udało się skopiować do schowka",
  "session.rewind.confirm": "Odrzuca kolejne tury i przywraca pliki",
  "session.usage.input": "Wejście",
  "session.usage.output": "Wyjście",
  "session.usage.reasoning": "Rozumowanie",
  "session.usage.cache": "Odczyty z pamięci podręcznej",
  "session.usage.turns": "Tury",
  "command.file.openExternal": "Otwórz plik w edytorze",
  "command.file.openExternal.description": "Przekazuje otwarty plik do VS Code, Cursora, Zeda lub Windsurfa",
  "command.file.openExternal.failed": "Tej ścieżki nie można otworzyć zewnętrznie",
  "command.agent.planToggle": "Tryb planowania",
  "command.agent.planToggle.toPlan": "Przelacz na planowanie: bada i pisze plan, ale nie edytuje",
  "command.agent.planToggle.toBuild": "Wroc do budowania",
  "command.agent.planToggle.on": "Tryb planowania wlaczony, edycje zablokowane",
  "command.agent.planToggle.off": "Tryb budowania wlaczony",
  "command.agent.planToggle.missing": "Ten projekt nie ma skonfigurowanego agenta planowania",
  "session.queue.title.one": "1 oczekuje na wyslanie",
  "command.session.exportMarkdown.done.one": "Skopiowano 1 wiersz",
  "browser.console.sendAll": "Wyslij wszystkie do czatu",
  "browser.console.sent": "Wyslano {{count}} bledow do czatu",
  "browser.console.sent.one": "Wyslano 1 blad do czatu",
  "browser.console.findCause": "Znajdz przyczyne i napraw ja.",
}
