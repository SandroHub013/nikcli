export const dict = {
  ...
  "prompt.placeholder.normal": "Спросите что угодно — / команды, @ файлы и агенты",
  ...
  "session.tasks.title": "Задачи",
  "command.session.rewind": "Вернуться сюда",
  "command.transcript.verbosity": "Уровень детализации",
  "transcript.verbosity.compact": "Кратко",
  "transcript.verbosity.normal": "Обычно",
  "transcript.verbosity.verbose": "Подробно",
  "session.new.shortcuts.more": "Нажмите {{keybind}} для остального",
  "command.browser.visualEditor": "Открыть визуальный редактор",
  "command.browser.visualEditor.description": "Изучайте элементы, меняйте стили и указывайте агенту",
  "github.pr.branchMissing": "Push выполнен, но \"{{branch}}\" нет в {{repo}} — вероятно, этот репозиторий не является удалённым для этой копии.",
  "github.device.denied": "Авторизация GitHub отклонена",
  "github.device.expired": "Код устройства истёк — начните заново",
  "command.session.follow": "Следовать за агентом",
  "command.session.follow.on": "Включено — редактор открывает каждый файл, который правит агент",
  "command.session.follow.off": "Выключено — редактор остаётся там, где вы его оставили",
  "command.browser.designMode": "Переключить режим дизайна",
  "command.browser.designMode.on": "Включено — щёлкайте элементы, чтобы изучать и править их",
  "command.browser.designMode.off": "Выключено — страница работает как обычно",
  "dialog.analytics.failed": "Не удалось загрузить данные об использовании",
  "dialog.analytics.allTime": "за всё время",
  "terminal.sendToChat": "Отправить вывод в чат",
  "terminal.sendToChat.empty": "В терминале нечего отправлять",
  "terminal.sendToChat.done": "Вывод терминала добавлен в запрос",
  "terminal.sendToChat.description": "Отправляет выделение или последние строки вывода в поле ввода",
  "session.queue.title": "{{count}} в очереди на отправку",
  "session.queue.steer": "Отправить сейчас, в текущий ход",
  "session.queue.steered": "Отправлено в текущий ход",
  "session.queue.steerFailed": "Не удалось отправить сейчас",
  "session.queue.takeBack": "Вернуть в поле ввода",
  "session.queue.takeBackFailed": "Не удалось вернуть — возможно, уже отправлено",
  "session.queue.takeBackAll": "Вернуть все",
  "session.queue.takeBackPartial": "Часть уже отправлена и не вернулась",
  "command.session.exportMarkdown": "Скопировать сессию как Markdown",
  "command.session.exportMarkdown.description": "Вопросы и ответы, готовые для вставки в задачу или ревью",
  "command.session.exportMarkdown.done": "Скопировано строк: {{lines}}",
  "command.session.exportMarkdown.failed": "Не удалось скопировать в буфер обмена",
  "session.rewind.confirm": "Отбросит следующие ходы и вернёт файлы",
  "session.usage.input": "Вход",
  "session.usage.output": "Выход",
  "session.usage.reasoning": "Рассуждение",
  "session.usage.cache": "Чтения из кэша",
  "session.usage.turns": "Ходы",
  "command.file.openExternal": "Открыть файл в редакторе",
  "command.file.openExternal.description": "Передаёт открытый файл в VS Code, Cursor, Zed или Windsurf",
  "command.file.openExternal.failed": "Этот путь нельзя открыть во внешнем редакторе",
  "command.agent.planToggle": "Режим планирования",
  "command.agent.planToggle.toPlan": "Перейти к планированию: изучает и пишет план, но не правит",
  "command.agent.planToggle.toBuild": "Вернуться к сборке",
  "command.agent.planToggle.on": "Режим планирования включён, правки запрещены",
  "command.agent.planToggle.off": "Режим сборки включён",
  "command.agent.planToggle.missing": "В этом проекте нет агента планирования",
  "session.queue.title.one": "1 в очереди на отправку",
  "command.session.exportMarkdown.done.one": "Скопирована 1 строка",
  "browser.console.sendAll": "Отправить все в чат",
  "browser.console.sent": "Ошибок отправлено: {{count}}",
  "browser.console.sent.one": "Отправлена 1 ошибка",
  "browser.console.findCause": "Найди причину и исправь.",
}
