export const dict = {
  ...
  "prompt.placeholder.normal": "Spørg om hvad som helst — / til kommandoer, @ til filer og agenter",
  ...
  "session.tasks.title": "Opgaver",
  "command.session.rewind": "Spol tilbage hertil",
  "command.transcript.verbosity": "Skift detaljeniveau",
  "transcript.verbosity.compact": "Kompakt",
  "transcript.verbosity.normal": "Normal",
  "transcript.verbosity.verbose": "Udførlig",
  "session.new.shortcuts.more": "Tryk {{keybind}} for alt andet",
  "command.browser.visualEditor": "Åbn visuel editor",
  "command.browser.visualEditor.description": "Inspicér elementer, redigér styles, og peg og bed agenten",
  "github.pr.branchMissing": "Pushet, men \"{{branch}}\" findes ikke på {{repo}} — det repository er sandsynligvis ikke remote for dette checkout.",
  "github.device.denied": "GitHub-godkendelsen blev afvist",
  "github.device.expired": "Enhedskoden udløb — start forfra",
  "command.session.follow": "Følg agenten",
  "command.session.follow.on": "Til — editoren åbner hver fil, agenten redigerer",
  "command.session.follow.off": "Fra — editoren bliver, hvor du satte den",
  "command.browser.designMode": "Slå designtilstand til/fra",
  "command.browser.designMode.on": "Til — klik på elementer for at inspicere og redigere dem",
  "command.browser.designMode.off": "Fra — siden opfører sig normalt",
  "dialog.analytics.failed": "Forbrugsdata kunne ikke indlæses",
  "dialog.analytics.allTime": "samlet",
  "terminal.sendToChat": "Send output til chatten",
  "terminal.sendToChat.empty": "Der er intet i terminalen at sende",
  "terminal.sendToChat.done": "Terminaloutput tilføjet til prompten",
  "terminal.sendToChat.description": "Sender markeringen, eller de sidste linjer output, til skrivefeltet",
  "session.queue.title": "{{count}} venter på at blive sendt",
  "session.queue.steer": "Send nu, ind i den igangværende tur",
  "session.queue.steered": "Sendt ind i den igangværende tur",
  "session.queue.steerFailed": "Kunne ikke sendes nu",
  "session.queue.takeBack": "Hent den tilbage i skrivefeltet",
  "session.queue.takeBackFailed": "Kunne ikke hentes tilbage — den er måske allerede sendt",
  "session.queue.takeBackAll": "Hent alle tilbage",
  "session.queue.takeBackPartial": "Nogle var allerede sendt og kunne ikke hentes tilbage",
  "command.session.exportMarkdown": "Kopiér sessionen som Markdown",
  "command.session.exportMarkdown.description": "Spørgsmål og svar, klar til at indsætte i en issue eller review",
  "command.session.exportMarkdown.done": "{{lines}} linjer kopieret",
  "command.session.exportMarkdown.failed": "Kunne ikke kopieres til udklipsholderen",
  "session.rewind.confirm": "Kasserer de efterfølgende ture og ruller filerne tilbage",
  "session.usage.input": "Input",
  "session.usage.output": "Output",
  "session.usage.reasoning": "Ræsonnement",
  "session.usage.cache": "Cache-læsninger",
  "session.usage.turns": "Ture",
  "command.file.openExternal": "Åbn filen i din editor",
  "command.file.openExternal.description": "Sender den åbne fil til VS Code, Cursor, Zed eller Windsurf",
  "command.file.openExternal.failed": "Den sti kan ikke åbnes eksternt",
  "command.agent.planToggle": "Plantilstand",
  "command.agent.planToggle.toPlan": "Skift til planlaegning: udforsker og skriver en plan, men redigerer ikke",
  "command.agent.planToggle.toBuild": "Tilbage til at bygge",
  "command.agent.planToggle.on": "Plantilstand til, redigeringer blokeret",
  "command.agent.planToggle.off": "Byggetilstand til",
  "command.agent.planToggle.missing": "Dette projekt har ingen plan-agent konfigureret",
  "session.queue.title.one": "1 venter pa at blive sendt",
  "command.session.exportMarkdown.done.one": "1 linje kopieret",
  "browser.console.sendAll": "Send alle til chatten",
  "browser.console.sent": "{{count}} fejl sendt til chatten",
  "browser.console.sent.one": "1 fejl sendt til chatten",
  "browser.console.findCause": "Find arsagen og ret den.",
}
