...
export const dict = {
  ...
  "prompt.placeholder.normal": "Spør om hva som helst — / for kommandoer, @ for filer og agenter",
  ...
  "session.tasks.title": "Oppgaver",
  "command.session.rewind": "Spol tilbake hit",
  "command.transcript.verbosity": "Bytt detaljnivå",
  "transcript.verbosity.compact": "Kompakt",
  "transcript.verbosity.normal": "Normal",
  "transcript.verbosity.verbose": "Detaljert",
  "session.new.shortcuts.more": "Trykk {{keybind}} for alt annet",
  "command.browser.visualEditor": "Åpne visuell editor",
  "command.browser.visualEditor.description": "Inspiser elementer, rediger stiler og pek og be agenten",
  "github.pr.branchMissing": "Pushet, men \"{{branch}}\" finnes ikke på {{repo}} — det repositoriet er trolig ikke remote for denne utsjekkingen.",
  "github.device.denied": "GitHub-autorisasjonen ble avvist",
  "github.device.expired": "Enhetskoden utløp — start på nytt",
  "command.session.follow": "Følg agenten",
  "command.session.follow.on": "På — editoren åpner hver fil agenten redigerer",
  "command.session.follow.off": "Av — editoren blir der du satte den",
  "command.browser.designMode": "Slå designmodus av/på",
  "command.browser.designMode.on": "På — klikk på elementer for å inspisere og redigere dem",
  "command.browser.designMode.off": "Av — siden oppfører seg normalt",
  "dialog.analytics.failed": "Kunne ikke laste bruksdata",
  "dialog.analytics.allTime": "totalt",
  "terminal.sendToChat": "Send utdata til chatten",
  "terminal.sendToChat.empty": "Ingenting i terminalen å sende",
  "terminal.sendToChat.done": "Terminalutdata lagt til i ledeteksten",
  "terminal.sendToChat.description": "Sender utvalget, eller de siste linjene med utdata, til skrivefeltet",
  "session.queue.title": "{{count}} venter på å bli sendt",
  "session.queue.steer": "Send nå, inn i gjeldende tur",
  "session.queue.steered": "Sendt inn i gjeldende tur",
  "session.queue.steerFailed": "Kunne ikke sendes nå",
  "session.queue.takeBack": "Hent den tilbake til skrivefeltet",
  "session.queue.takeBackFailed": "Kunne ikke hentes tilbake — den er kanskje allerede sendt",
  "session.queue.takeBackAll": "Hent alle tilbake",
  "session.queue.takeBackPartial": "Noen var allerede sendt og kunne ikke hentes tilbake",
  "command.session.exportMarkdown": "Kopier økten som Markdown",
  "command.session.exportMarkdown.description": "Spørsmål og svar, klare til å limes inn i en issue eller review",
  "command.session.exportMarkdown.done": "{{lines}} linjer kopiert",
  "command.session.exportMarkdown.failed": "Kunne ikke kopieres til utklippstavlen",
  "session.rewind.confirm": "Forkaster de påfølgende turene og tilbakestiller filene",
  "session.usage.input": "Inn",
  "session.usage.output": "Ut",
  "session.usage.reasoning": "Resonnering",
  "session.usage.cache": "Cache-lesinger",
  "session.usage.turns": "Turer",
  "command.file.openExternal": "Åpne filen i editoren din",
  "command.file.openExternal.description": "Sender den åpne filen til VS Code, Cursor, Zed eller Windsurf",
  "command.file.openExternal.failed": "Den stien kan ikke åpnes eksternt",
  "command.agent.planToggle": "Planmodus",
  "command.agent.planToggle.toPlan": "Bytt til planlegging: utforsker og skriver en plan, men redigerer ikke",
  "command.agent.planToggle.toBuild": "Tilbake til bygging",
  "command.agent.planToggle.on": "Planmodus pa, redigeringer blokkert",
  "command.agent.planToggle.off": "Byggemodus pa",
  "command.agent.planToggle.missing": "Dette prosjektet har ingen planagent konfigurert",
  "session.queue.title.one": "1 venter pa a bli sendt",
  "command.session.exportMarkdown.done.one": "1 linje kopiert",
  "browser.console.sendAll": "Send alle til chatten",
  "browser.console.sent": "{{count}} feil sendt til chatten",
  "browser.console.sent.one": "1 feil sendt til chatten",
  "browser.console.findCause": "Finn arsaken og rett den.",
