export const dict = {
  ...
  "prompt.placeholder.normal": "Pergunte qualquer coisa — / para comandos, @ para arquivos e agentes",
  ...
  "session.tasks.title": "Tarefas",
  "command.session.rewind": "Voltar para aqui",
  "command.transcript.verbosity": "Alternar detalhe do histórico",
  "transcript.verbosity.compact": "Compacto",
  "transcript.verbosity.normal": "Normal",
  "transcript.verbosity.verbose": "Detalhado",
  "session.new.shortcuts.more": "Pressione {{keybind}} para todo o resto",
  "command.browser.visualEditor": "Abrir editor visual",
  "command.browser.visualEditor.description": "Inspecione elementos, edite estilos e aponte e peça ao agente",
  "github.pr.branchMissing": "Push feito, mas \"{{branch}}\" não está em {{repo}} — esse repositório provavelmente não é o remoto deste checkout.",
  "github.device.denied": "Autorização do GitHub negada",
  "github.device.expired": "O código do dispositivo expirou — comece de novo",
  "command.session.follow": "Seguir o agente",
  "command.session.follow.on": "Ligado — o editor abre cada arquivo que o agente edita",
  "command.session.follow.off": "Desligado — o editor fica onde você deixou",
  "command.browser.designMode": "Alternar modo design",
  "command.browser.designMode.on": "Ligado — clique nos elementos para inspecioná-los e editá-los",
  "command.browser.designMode.off": "Desligado — a página se comporta normalmente",
  "dialog.analytics.failed": "Não foi possível carregar os dados de uso",
  "dialog.analytics.allTime": "desde sempre",
  "terminal.sendToChat": "Enviar saída para o chat",
  "terminal.sendToChat.empty": "Não há nada no terminal para enviar",
  "terminal.sendToChat.done": "Saída do terminal adicionada ao prompt",
  "terminal.sendToChat.description": "Envia a seleção, ou as últimas linhas da saída, para o campo de mensagem",
  "session.queue.title": "{{count}} aguardando envio",
  "session.queue.steer": "Enviar agora, no turno em andamento",
  "session.queue.steered": "Enviado ao turno em andamento",
  "session.queue.steerFailed": "Não foi possível enviar agora",
  "session.queue.takeBack": "Trazer de volta para o campo de mensagem",
  "session.queue.takeBackFailed": "Não foi possível trazer de volta — talvez já tenha sido enviado",
  "session.queue.takeBackAll": "Trazer todos de volta",
  "session.queue.takeBackPartial": "Alguns já haviam sido enviados e não puderam voltar",
  "command.session.exportMarkdown": "Copiar a sessão como Markdown",
  "command.session.exportMarkdown.description": "Perguntas e respostas, prontas para colar em uma issue ou revisão",
  "command.session.exportMarkdown.done": "{{lines}} linhas copiadas",
  "command.session.exportMarkdown.failed": "Não foi possível copiar para a área de transferência",
  "session.rewind.confirm": "Descarta os turnos seguintes e reverte os arquivos",
  "session.usage.input": "Entrada",
  "session.usage.output": "Saída",
  "session.usage.reasoning": "Raciocínio",
  "session.usage.cache": "Leituras de cache",
  "session.usage.turns": "Turnos",
  "command.file.openExternal": "Abrir o arquivo no seu editor",
  "command.file.openExternal.description": "Entrega o arquivo aberto ao VS Code, Cursor, Zed ou Windsurf",
  "command.file.openExternal.failed": "Esse caminho não pode ser aberto externamente",
  "command.agent.planToggle": "Modo plano",
  "command.agent.planToggle.toPlan": "Mudar para planejamento: explora e escreve um plano, mas nao edita",
  "command.agent.planToggle.toBuild": "Voltar a construir",
  "command.agent.planToggle.on": "Modo plano ligado, edicoes bloqueadas",
  "command.agent.planToggle.off": "Modo construcao ligado",
  "command.agent.planToggle.missing": "Este projeto nao tem agente de planejamento configurado",
  "session.queue.title.one": "1 aguardando envio",
  "command.session.exportMarkdown.done.one": "1 linha copiada",
  "browser.console.sendAll": "Enviar todos para o chat",
  "browser.console.sent": "{{count}} erros enviados para o chat",
  "browser.console.sent.one": "1 erro enviado para o chat",
  "browser.console.findCause": "Encontre a causa e corrija.",
}
