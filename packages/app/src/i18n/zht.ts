...
export const dict = {
  ...
  "prompt.placeholder.normal": "問任何問題 — / 呼叫命令，@ 引用檔案和代理",
  ...
  "session.tasks.title": "任務",
  "command.session.rewind": "回退到此處",
  "command.transcript.verbosity": "切換記錄詳細程度",
  "transcript.verbosity.compact": "精簡",
  "transcript.verbosity.normal": "標準",
  "transcript.verbosity.verbose": "詳細",
  "session.new.shortcuts.more": "按 {{keybind}} 檢視其他命令",
  "command.browser.visualEditor": "開啟視覺化編輯器",
  "command.browser.visualEditor.description": "檢查元素、編輯樣式，並指向元素向代理下達指令",
  "github.pr.branchMissing": "已推送，但 \"{{branch}}\" 不在 {{repo}} 中 — 該儲存庫可能不是此檢出的遠端。",
  "github.device.denied": "GitHub 授權遭拒",
  "github.device.expired": "裝置代碼已過期 — 請重新開始",
  "command.session.follow": "跟隨智能體",
  "command.session.follow.on": "已開啟 — 編輯器會開啟智能體正在修改的檔案",
  "command.session.follow.off": "已關閉 — 編輯器停留在你開啟的位置",
  "command.browser.designMode": "切換設計模式",
  "command.browser.designMode.on": "已開啟 — 點擊元素即可檢視與編輯",
  "command.browser.designMode.off": "已關閉 — 頁面正常運作",
  "dialog.analytics.failed": "無法載入使用資料",
  "dialog.analytics.allTime": "全部時間",
  "terminal.sendToChat": "將輸出傳送到對話",
  "terminal.sendToChat.empty": "終端機沒有可傳送的內容",
  "terminal.sendToChat.done": "終端機輸出已加入提示",
  "terminal.sendToChat.description": "將選取內容或輸出的最後幾行傳送到輸入框",
  "session.queue.title": "{{count}} 則等待傳送",
  "session.queue.steer": "立即傳送到進行中的回合",
  "session.queue.steered": "已傳送到進行中的回合",
  "session.queue.steerFailed": "現在無法傳送",
  "session.queue.takeBack": "取回到輸入框",
  "session.queue.takeBackFailed": "無法取回 — 可能已經傳送",
  "session.queue.takeBackAll": "全部取回",
  "session.queue.takeBackPartial": "部分已傳送，無法取回",
  "command.session.exportMarkdown": "將工作階段複製為 Markdown",
  "command.session.exportMarkdown.description": "問答內容，可直接貼到 issue 或審查中",
  "command.session.exportMarkdown.done": "已複製 {{lines}} 行",
  "command.session.exportMarkdown.failed": "無法複製到剪貼簿",
  "session.rewind.confirm": "捨棄之後的回合並還原檔案",
  "session.usage.input": "輸入",
  "session.usage.output": "輸出",
  "session.usage.reasoning": "推理",
  "session.usage.cache": "快取讀取",
  "session.usage.turns": "回合",
  "command.file.openExternal": "在你的編輯器中開啟檔案",
  "command.file.openExternal.description": "把目前檔案交給 VS Code、Cursor、Zed 或 Windsurf",
  "command.file.openExternal.failed": "該路徑無法在外部開啟",
  "command.agent.planToggle": "計畫模式",
  "command.agent.planToggle.toPlan": "切換到計畫：只探索與撰寫計畫，不修改程式碼",
  "command.agent.planToggle.toBuild": "切回建置",
  "command.agent.planToggle.on": "計畫模式已開啟，禁止修改",
  "command.agent.planToggle.off": "建置模式已開啟",
  "command.agent.planToggle.missing": "該專案未設定計畫智能體",
  "session.queue.title.one": "1 則等待傳送",
  "command.session.exportMarkdown.done.one": "已複製 1 行",
  "browser.console.sendAll": "全部傳送到對話",
  "browser.console.sent": "已傳送 {{count}} 個錯誤",
  "browser.console.sent.one": "已傳送 1 個錯誤",
  "browser.console.findCause": "找出原因並修復。",
