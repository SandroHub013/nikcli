export const dict = {
  ...
  "prompt.placeholder.normal": "何でも聞いてください — / でコマンド、@ でファイルとエージェント",
  ...
  "session.tasks.title": "タスク",
  "command.session.rewind": "ここまで巻き戻す",
  "command.transcript.verbosity": "表示の詳細度を切り替え",
  "transcript.verbosity.compact": "簡潔",
  "transcript.verbosity.normal": "標準",
  "transcript.verbosity.verbose": "詳細",
  "session.new.shortcuts.more": "その他は {{keybind}}",
  "command.browser.visualEditor": "ビジュアルエディタを開く",
  "command.browser.visualEditor.description": "要素を調べ、スタイルを編集し、エージェントに指示する",
  "github.pr.branchMissing": "push しましたが、\"{{branch}}\" は {{repo}} にありません。そのリポジトリはこのチェックアウトのリモートではない可能性があります。",
  "github.device.denied": "GitHub の認可が拒否されました",
  "github.device.expired": "デバイスコードの有効期限が切れました。もう一度お試しください",
  "command.session.follow": "エージェントを追従",
  "command.session.follow.on": "オン — エージェントが編集するファイルをエディタが開きます",
  "command.session.follow.off": "オフ — エディタは開いたままの場所にとどまります",
  "command.browser.designMode": "デザインモードを切り替え",
  "command.browser.designMode.on": "オン — 要素をクリックして調査・編集できます",
  "command.browser.designMode.off": "オフ — ページは通常どおり動作します",
  "dialog.analytics.failed": "使用状況データを読み込めませんでした",
  "dialog.analytics.allTime": "全期間",
  "terminal.sendToChat": "出力をチャットに送る",
  "terminal.sendToChat.empty": "ターミナルに送るものがありません",
  "terminal.sendToChat.done": "ターミナルの出力をプロンプトに追加しました",
  "terminal.sendToChat.description": "選択範囲、または出力の末尾を入力欄に送ります",
  "session.queue.title": "送信待ち {{count}} 件",
  "session.queue.steer": "実行中のターンに今すぐ送る",
  "session.queue.steered": "実行中のターンに送信しました",
  "session.queue.steerFailed": "今すぐ送信できませんでした",
  "session.queue.takeBack": "入力欄に戻す",
  "session.queue.takeBackFailed": "戻せませんでした。すでに送信された可能性があります",
  "session.queue.takeBackAll": "すべて戻す",
  "session.queue.takeBackPartial": "一部はすでに送信済みで戻せませんでした",
  "command.session.exportMarkdown": "セッションを Markdown でコピー",
  "command.session.exportMarkdown.description": "質問と回答を、Issue やレビューにそのまま貼れる形で",
  "command.session.exportMarkdown.done": "{{lines}} 行をコピーしました",
  "command.session.exportMarkdown.failed": "クリップボードにコピーできませんでした",
  "session.rewind.confirm": "これ以降のターンを破棄し、ファイルを元に戻します",
  "session.usage.input": "入力",
  "session.usage.output": "出力",
  "session.usage.reasoning": "推論",
  "session.usage.cache": "キャッシュ読み取り",
  "session.usage.turns": "ターン",
  "command.file.openExternal": "ファイルをエディタで開く",
  "command.file.openExternal.description": "開いているファイルを VS Code / Cursor / Zed / Windsurf に渡します",
  "command.file.openExternal.failed": "このパスは外部で開けません",
  "command.agent.planToggle": "プランモード",
  "command.agent.planToggle.toPlan": "計画に切り替え: 調査と計画作成のみで、編集はしません",
  "command.agent.planToggle.toBuild": "ビルドに戻る",
  "command.agent.planToggle.on": "プランモード オン、編集は拒否",
  "command.agent.planToggle.off": "ビルドモード オン",
  "command.agent.planToggle.missing": "このプロジェクトにはプランエージェントがありません",
  "session.queue.title.one": "送信待ち 1 件",
  "command.session.exportMarkdown.done.one": "1 行をコピーしました",
  "browser.console.sendAll": "すべてチャットに送る",
  "browser.console.sent": "{{count}} 件のエラーを送信しました",
  "browser.console.sent.one": "1 件のエラーを送信しました",
  "browser.console.findCause": "原因を特定して修正してください。",
}
