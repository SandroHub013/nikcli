...
export const dict = {
  ...
  "prompt.placeholder.normal": "무엇이든 물어보세요 — / 명령, @ 파일과 에이전트",
  ...
  "session.tasks.title": "작업",
  "command.session.rewind": "여기로 되돌리기",
  "command.transcript.verbosity": "대화 상세도 전환",
  "transcript.verbosity.compact": "간결",
  "transcript.verbosity.normal": "보통",
  "transcript.verbosity.verbose": "상세",
  "session.new.shortcuts.more": "나머지는 {{keybind}}",
  "command.browser.visualEditor": "비주얼 에디터 열기",
  "command.browser.visualEditor.description": "요소를 검사하고 스타일을 편집하며 에이전트에 지시",
  "github.pr.branchMissing": "푸시했지만 \"{{branch}}\"이(가) {{repo}}에 없습니다. 해당 저장소는 이 체크아웃의 원격이 아닐 수 있습니다.",
  "github.device.denied": "GitHub 인증이 거부되었습니다",
  "github.device.expired": "기기 코드가 만료되었습니다. 다시 시도하세요",
  "command.session.follow": "에이전트 따라가기",
  "command.session.follow.on": "켜짐 — 에이전트가 편집하는 파일을 편집기가 엽니다",
  "command.session.follow.off": "꺼짐 — 편집기는 열어 둔 자리에 머무릅니다",
  "command.browser.designMode": "디자인 모드 전환",
  "command.browser.designMode.on": "켜짐 — 요소를 클릭해 살펴보고 편집합니다",
  "command.browser.designMode.off": "꺼짐 — 페이지가 평소대로 동작합니다",
  "dialog.analytics.failed": "사용량 데이터를 불러오지 못했습니다",
  "dialog.analytics.allTime": "전체 기간",
  "terminal.sendToChat": "출력을 채팅으로 보내기",
  "terminal.sendToChat.empty": "터미널에 보낼 내용이 없습니다",
  "terminal.sendToChat.done": "터미널 출력을 프롬프트에 추가했습니다",
  "terminal.sendToChat.description": "선택 영역 또는 출력의 마지막 줄을 입력창으로 보냅니다",
  "session.queue.title": "전송 대기 {{count}}건",
  "session.queue.steer": "지금 보내기 — 진행 중인 턴에",
  "session.queue.steered": "진행 중인 턴으로 보냈습니다",
  "session.queue.steerFailed": "지금 보내지 못했습니다",
  "session.queue.takeBack": "입력창으로 되돌리기",
  "session.queue.takeBackFailed": "되돌리지 못했습니다 — 이미 전송되었을 수 있습니다",
  "session.queue.takeBackAll": "모두 되돌리기",
  "session.queue.takeBackPartial": "일부는 이미 전송되어 되돌릴 수 없었습니다",
  "command.session.exportMarkdown": "세션을 Markdown으로 복사",
  "command.session.exportMarkdown.description": "질문과 답변을 이슈나 리뷰에 바로 붙여넣을 형태로",
  "command.session.exportMarkdown.done": "{{lines}}줄 복사했습니다",
  "command.session.exportMarkdown.failed": "클립보드로 복사하지 못했습니다",
  "session.rewind.confirm": "이후 턴을 버리고 파일을 되돌립니다",
  "session.usage.input": "입력",
  "session.usage.output": "출력",
  "session.usage.reasoning": "추론",
  "session.usage.cache": "캐시 읽기",
  "session.usage.turns": "턴",
  "command.file.openExternal": "파일을 편집기에서 열기",
  "command.file.openExternal.description": "열린 파일을 VS Code, Cursor, Zed 또는 Windsurf로 넘깁니다",
  "command.file.openExternal.failed": "이 경로는 외부에서 열 수 없습니다",
  "command.agent.planToggle": "플랜 모드",
  "command.agent.planToggle.toPlan": "계획으로 전환: 탐색과 계획 작성만 하고 편집은 하지 않습니다",
  "command.agent.planToggle.toBuild": "빌드로 돌아가기",
  "command.agent.planToggle.on": "플랜 모드 켜짐, 편집 차단",
  "command.agent.planToggle.off": "빌드 모드 켜짐",
  "command.agent.planToggle.missing": "이 프로젝트에는 플랜 에이전트가 없습니다",
  "session.queue.title.one": "전송 대기 1건",
  "command.session.exportMarkdown.done.one": "1줄 복사했습니다",
  "browser.console.sendAll": "모두 채팅으로 보내기",
  "browser.console.sent": "오류 {{count}}건을 보냈습니다",
  "browser.console.sent.one": "오류 1건을 보냈습니다",
  "browser.console.findCause": "원인을 찾아 고쳐 주세요.",
}
