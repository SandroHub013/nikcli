export const dict = {
  ...
  "prompt.placeholder.normal": "Pregunta lo que sea — / para comandos, @ para archivos y agentes",
  ...
  "session.tasks.title": "Tareas",
  "command.session.rewind": "Volver aquí",
  "command.transcript.verbosity": "Cambiar nivel de detalle",
  "transcript.verbosity.compact": "Compacto",
  "transcript.verbosity.normal": "Normal",
  "transcript.verbosity.verbose": "Detallado",
  "session.new.shortcuts.more": "Pulsa {{keybind}} para todo lo demás",
  "command.browser.visualEditor": "Abrir editor visual",
  "command.browser.visualEditor.description": "Inspecciona elementos, edita estilos y señala e indica al agente",
  "github.pr.branchMissing": "Se hizo push, pero \"{{branch}}\" no está en {{repo}}: ese repositorio probablemente no es el remoto de esta copia.",
  "github.device.denied": "Se denegó la autorización de GitHub",
  "github.device.expired": "El código de dispositivo caducó: vuelve a empezar",
  "command.session.follow": "Seguir al agente",
  "command.session.follow.on": "Activado: el editor abre cada archivo que el agente modifica",
  "command.session.follow.off": "Desactivado: el editor se queda donde lo dejaste",
  "command.browser.designMode": "Alternar modo diseño",
  "command.browser.designMode.on": "Activado: haz clic en los elementos para inspeccionarlos y editarlos",
  "command.browser.designMode.off": "Desactivado: la página funciona con normalidad",
  "dialog.analytics.failed": "No se pudieron cargar los datos de uso",
  "dialog.analytics.allTime": "histórico",
  "terminal.sendToChat": "Enviar salida al chat",
  "terminal.sendToChat.empty": "No hay nada en la terminal para enviar",
  "terminal.sendToChat.done": "Salida de la terminal añadida al prompt",
  "terminal.sendToChat.description": "Envía la selección, o las últimas líneas de salida, al compositor",
  "session.queue.title": "{{count}} en espera de envío",
  "session.queue.steer": "Enviar ahora, en el turno en curso",
  "session.queue.steered": "Enviado al turno en curso",
  "session.queue.steerFailed": "No se pudo enviar ahora",
  "session.queue.takeBack": "Recuperarlo en el editor",
  "session.queue.takeBackFailed": "No se pudo recuperar: puede que ya se haya enviado",
  "session.queue.takeBackAll": "Recuperar todos",
  "session.queue.takeBackPartial": "Algunos ya se habían enviado y no pudieron recuperarse",
  "command.session.exportMarkdown": "Copiar la sesión como Markdown",
  "command.session.exportMarkdown.description": "Preguntas y respuestas, listas para pegar en una incidencia o revisión",
  "command.session.exportMarkdown.done": "{{lines}} líneas copiadas",
  "command.session.exportMarkdown.failed": "No se pudo copiar al portapapeles",
  "session.rewind.confirm": "Descarta los turnos posteriores y revierte los archivos",
  "session.usage.input": "Entrada",
  "session.usage.output": "Salida",
  "session.usage.reasoning": "Razonamiento",
  "session.usage.cache": "Lecturas de caché",
  "session.usage.turns": "Turnos",
  "command.file.openExternal": "Abrir el archivo en tu editor",
  "command.file.openExternal.description": "Entrega el archivo abierto a VS Code, Cursor, Zed o Windsurf",
  "command.file.openExternal.failed": "Esa ruta no se puede abrir externamente",
  "command.agent.planToggle": "Modo plan",
  "command.agent.planToggle.toPlan": "Cambiar a planificacion: explora y escribe un plan, pero no puede editar",
  "command.agent.planToggle.toBuild": "Volver a construir",
  "command.agent.planToggle.on": "Modo plan activado: ediciones bloqueadas",
  "command.agent.planToggle.off": "Modo construccion activado",
  "command.agent.planToggle.missing": "Este proyecto no tiene agente de planificacion configurado",
  "session.queue.title.one": "1 en espera de envio",
  "command.session.exportMarkdown.done.one": "1 linea copiada",
  "browser.console.sendAll": "Enviar todos al chat",
  "browser.console.sent": "{{count}} errores enviados al chat",
  "browser.console.sent.one": "1 error enviado al chat",
  "browser.console.findCause": "Encuentra la causa y corrigela.",
}
