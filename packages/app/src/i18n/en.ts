export const dict = {
  ...
  "prompt.placeholder.normal": "Ask anything — / for commands, @ for files and agents",
  ...
  "dialog.analytics.description": "Usage across all sessions, for the selected window",
  ...
  "toast.update.failed": "Update failed to install",
  ...
  "github.oauth.clientDescription":
    "Optional. Nikcli already uses the official GitHub App by default — set a custom client ID only if you need a different OAuth application. Turn on \"Device flow\" in that app's settings, or GitHub refuses the request.",
  ...
  "github.oauth.codeHint": "Type this code only if the GitHub page did not fill it in for you.",
  "github.oauth.createClient": "Create an OAuth app on GitHub",
  "github.oauth.open": "Open GitHub",
  "github.oauth.check": "Check authorization",
  "github.oauth.waiting": "Waiting for authorization — approve it in your browser and this dialog updates on its own.",
  ...
  "github.pr.branchMissing": "Pushed, but \"{{branch}}\" is not on {{repo}} — that repository is probably not this checkout's remote.",
  "github.pr.noRepos": "No GitHub repositories are available for this account.",
  "session.tasks.title": "Tasks",
  "command.session.rewind": "Rewind to here",
  "command.transcript.verbosity": "Cycle transcript detail",
  "transcript.verbosity.compact": "Compact",
  "transcript.verbosity.normal": "Normal",
  "transcript.verbosity.verbose": "Verbose",
  "session.new.shortcuts.more": "Press {{keybind}} for everything else",
  "command.browser.visualEditor": "Open visual editor",
  "command.browser.visualEditor.description": "Inspect elements, edit styles, and point and prompt the agent",
  "dialog.analytics.byProject": "Top projects",
  "dialog.analytics.cacheHit": "Cache hit rate",
  "dialog.analytics.tokensPerDay": "Tokens per day",
  "dialog.analytics.perSession": "per session",
  "github.device.denied": "GitHub authorization was denied",
  "github.device.misconfigured": "GitHub rejected this app's device sign-in. Check the client ID, and that \"Device flow\" is enabled on the OAuth app.",
  "github.device.expired": "The device code expired — start again",
  "command.session.follow": "Follow the agent",
  "command.session.follow.on": "On — the editor opens each file the agent edits",
  "command.session.follow.off": "Off — the editor stays where you put it",
  ...
  "dialog.analytics.failed": "Could not load usage data",
  "dialog.analytics.allTime": "all time",
  "terminal.sendToChat": "Send output to chat",
  "terminal.sendToChat.empty": "Nothing on the terminal to send",
  "terminal.sendToChat.done": "Terminal output added to the prompt",
  "terminal.sendToChat.description": "Send the selection, or the last lines of output, to the composer",
  "session.queue.title": "{{count}} waiting to send",
  "session.queue.steer": "Send now, into the running turn",
  "session.queue.steered": "Sent into the running turn",
  "session.queue.steerFailed": "Could not send it now",
  "session.queue.takeBack": "Take it back into the composer",
  "session.queue.takeBackFailed": "Could not take it back — it may already have been sent",
  "session.queue.takeBackAll": "Take all back",
  "session.queue.takeBackPartial": "Some had already been sent and could not come back",
  "command.session.exportMarkdown": "Copy the session as Markdown",
  "command.session.exportMarkdown.description": "Prompts and answers, ready to paste into an issue or a review",
  "command.session.exportMarkdown.done": "{{lines}} lines copied",
  "command.session.exportMarkdown.failed": "Could not copy to the clipboard",
  "session.rewind.confirm": "Discards the turns after this and reverts the files",
  "session.usage.input": "Input",
  "session.usage.output": "Output",
  "session.usage.reasoning": "Reasoning",
  "session.usage.cache": "Cache reads",
  "session.usage.turns": "Turns",
  "command.file.openExternal": "Open the file in your editor",
  "command.file.openExternal.description": "Hands the open file to VS Code, Cursor, Zed or Windsurf",
  "command.file.openExternal.failed": "That path cannot be opened externally",
  "command.agent.planToggle": "Plan mode",
  "command.agent.planToggle.toPlan": "Switch to planning: the agent explores and writes a plan, but cannot edit",
  "command.agent.planToggle.toBuild": "Switch back to building",
  "command.agent.planToggle.on": "Plan mode on, edits are denied",
  "command.agent.planToggle.off": "Build mode on",
  "command.agent.planToggle.missing": "This project has no plan agent configured",
  "session.queue.title.one": "1 waiting to send",
  "command.session.exportMarkdown.done.one": "1 line copied",
