export const dict = {
  ...
  "prompt.placeholder.normal": "اسأل أي شيء — / للأوامر، @ للملفات والوكلاء",
  ...
  "session.tasks.title": "المهام",
  "command.session.rewind": "الرجوع إلى هنا",
  "command.transcript.verbosity": "تبديل مستوى تفاصيل النص",
  "transcript.verbosity.compact": "مختصر",
  "transcript.verbosity.normal": "عادي",
  "transcript.verbosity.verbose": "مفصل",
  "session.new.shortcuts.more": "اضغط {{keybind}} لبقية الأوامر",
  "command.browser.visualEditor": "فتح المحرر المرئي",
  "command.browser.visualEditor.description": "افحص العناصر، عدّل الأنماط، وأشر واطلب من الوكيل",
  "github.pr.branchMissing": "تم الدفع، لكن \"{{branch}}\" غير موجود في {{repo}} — على الأرجح أن هذا المستودع ليس المستودع البعيد لهذه النسخة.",
  "github.device.denied": "تم رفض تفويض GitHub",
  "github.device.expired": "انتهت صلاحية رمز الجهاز — ابدأ من جديد",
  "command.session.follow": "تابع الوكيل",
  "command.session.follow.on": "مُفعّل — يفتح المحرر كل ملف يعدّله الوكيل",
  "command.session.follow.off": "مُعطّل — يبقى المحرر حيث تركته",
  "command.browser.designMode": "تبديل وضع التصميم",
  "command.browser.designMode.on": "مُفعّل — انقر العناصر لفحصها وتحريرها",
  "command.browser.designMode.off": "مُعطّل — تعمل الصفحة بشكل طبيعي",
  "dialog.analytics.failed": "تعذّر تحميل بيانات الاستخدام",
  "dialog.analytics.allTime": "كل الأوقات",
  "terminal.sendToChat": "أرسل المخرجات إلى المحادثة",
  "terminal.sendToChat.empty": "لا يوجد شيء في الطرفية لإرساله",
  "terminal.sendToChat.done": "أُضيفت مخرجات الطرفية إلى الطلب",
  "terminal.sendToChat.description": "يرسل التحديد، أو آخر أسطر المخرجات، إلى حقل الكتابة",
  "session.queue.title": "{{count}} في انتظار الإرسال",
  "session.queue.steer": "أرسل الآن، ضمن الدور الجاري",
  "session.queue.steered": "أُرسل إلى الدور الجاري",
  "session.queue.steerFailed": "تعذّر إرساله الآن",
  "session.queue.takeBack": "أعده إلى حقل الكتابة",
  "session.queue.takeBackFailed": "تعذّر استرجاعه — ربما أُرسل بالفعل",
  "session.queue.takeBackAll": "أعد الكل",
  "session.queue.takeBackPartial": "بعضها أُرسل بالفعل ولم يُسترجع",
  "command.session.exportMarkdown": "انسخ الجلسة بصيغة Markdown",
  "command.session.exportMarkdown.description": "الأسئلة والأجوبة، جاهزة للصق في مسألة أو مراجعة",
  "command.session.exportMarkdown.done": "نُسخ {{lines}} سطرًا",
  "command.session.exportMarkdown.failed": "تعذّر النسخ إلى الحافظة",
  "session.rewind.confirm": "يتجاهل الأدوار التالية ويعيد الملفات",
  "session.usage.input": "المدخلات",
  "session.usage.output": "المخرجات",
  "session.usage.reasoning": "الاستدلال",
  "session.usage.cache": "قراءات الذاكرة المؤقتة",
  "session.usage.turns": "الأدوار",
  "command.file.openExternal": "افتح الملف في محررك",
  "command.file.openExternal.description": "يسلّم الملف المفتوح إلى VS Code أو Cursor أو Zed أو Windsurf",
  "command.file.openExternal.failed": "لا يمكن فتح هذا المسار خارجيًا",
  "command.agent.planToggle": "وضع التخطيط",
  "command.agent.planToggle.toPlan": "التبديل إلى التخطيط: يستكشف ويكتب خطة دون تحرير",
  "command.agent.planToggle.toBuild": "العودة إلى البناء",
  "command.agent.planToggle.on": "وضع التخطيط مفعل، التحرير ممنوع",
  "command.agent.planToggle.off": "وضع البناء مفعل",
  "command.agent.planToggle.missing": "لا يوجد وكيل تخطيط لهذا المشروع",
  "session.queue.title.one": "1 في انتظار الإرسال",
  "command.session.exportMarkdown.done.one": "نُسخ سطر واحد",
  "browser.console.sendAll": "أرسل الكل إلى المحادثة",
  "browser.console.sent": "أُرسلت {{count}} أخطاء إلى المحادثة",
  "browser.console.sent.one": "أُرسل خطأ واحد إلى المحادثة",
  "browser.console.findCause": "ابحث عن السبب وأصلحه.",
}
