export const dict = {
  ...
  "prompt.placeholder.normal": "Pitajte bilo šta — / za komande, @ za datoteke i agente",
  ...
  "session.tasks.title": "Zadaci",
  "command.session.rewind": "Vrati se ovdje",
  "command.transcript.verbosity": "Promijeni nivo detalja",
  "transcript.verbosity.compact": "Sažeto",
  "transcript.verbosity.normal": "Normalno",
  "transcript.verbosity.verbose": "Detaljno",
  "session.new.shortcuts.more": "Pritisnite {{keybind}} za sve ostalo",
  "command.browser.visualEditor": "Otvori vizuelni uređivač",
  "command.browser.visualEditor.description": "Pregledaj elemente, uredi stilove i uputi agenta",
  "github.pr.branchMissing": "Push je urađen, ali \"{{branch}}\" nije na {{repo}} — taj repozitorij vjerovatno nije remote ovog checkouta.",
  "github.device.denied": "GitHub autorizacija je odbijena",
  "github.device.expired": "Kod uređaja je istekao — pokrenite ponovo",
  "command.session.follow": "Prati agenta",
  "command.session.follow.on": "Uključeno — editor otvara svaku datoteku koju agent mijenja",
  "command.session.follow.off": "Isključeno — editor ostaje gdje ste ga ostavili",
  "command.browser.designMode": "Uključi/isključi dizajn način",
  "command.browser.designMode.on": "Uključeno — kliknite elemente da ih pregledate i uredite",
  "command.browser.designMode.off": "Isključeno — stranica se ponaša normalno",
  "dialog.analytics.failed": "Nije moguće učitati podatke o korištenju",
  "dialog.analytics.allTime": "ukupno",
  "terminal.sendToChat": "Pošalji izlaz u chat",
  "terminal.sendToChat.empty": "Nema ništa u terminalu za slanje",
  "terminal.sendToChat.done": "Izlaz terminala dodan u prompt",
  "terminal.sendToChat.description": "Šalje odabir, ili posljednje linije izlaza, u polje za poruku",
  "session.queue.title": "{{count}} čeka slanje",
  "session.queue.steer": "Pošalji odmah, u trenutni krug",
  "session.queue.steered": "Poslano u trenutni krug",
  "session.queue.steerFailed": "Slanje sada nije uspjelo",
  "session.queue.takeBack": "Vrati u polje za pisanje",
  "session.queue.takeBackFailed": "Nije moguće vratiti — možda je već poslano",
  "session.queue.takeBackAll": "Vrati sve",
  "session.queue.takeBackPartial": "Neki su već poslani i nisu se mogli vratiti",
  "command.session.exportMarkdown": "Kopiraj sesiju kao Markdown",
  "command.session.exportMarkdown.description": "Pitanja i odgovori, spremni za lijepljenje u issue ili pregled",
  "command.session.exportMarkdown.done": "{{lines}} linija kopirano",
  "command.session.exportMarkdown.failed": "Kopiranje u međuspremnik nije uspjelo",
  "session.rewind.confirm": "Odbacuje naredne krugove i vraća datoteke",
  "session.usage.input": "Ulaz",
  "session.usage.output": "Izlaz",
  "session.usage.reasoning": "Rezonovanje",
  "session.usage.cache": "Čitanja iz keša",
  "session.usage.turns": "Krugovi",
  "command.file.openExternal": "Otvori datoteku u svom editoru",
  "command.file.openExternal.description": "Predaje otvorenu datoteku VS Codeu, Cursoru, Zedu ili Windsurfu",
  "command.file.openExternal.failed": "Ta putanja se ne može otvoriti izvana",
  "command.agent.planToggle": "Nacin planiranja",
  "command.agent.planToggle.toPlan": "Prebaci na planiranje: istrazuje i pise plan, ali ne uredjuje",
  "command.agent.planToggle.toBuild": "Nazad na gradnju",
  "command.agent.planToggle.on": "Planiranje ukljuceno, izmjene onemogucene",
  "command.agent.planToggle.off": "Nacin gradnje ukljucen",
  "command.agent.planToggle.missing": "Ovaj projekt nema konfiguriran agent za planiranje",
  "session.queue.title.one": "1 ceka slanje",
  "command.session.exportMarkdown.done.one": "1 linija kopirana",
  "browser.console.sendAll": "Posalji sve u chat",
  "browser.console.sent": "{{count}} gresaka poslano u chat",
  "browser.console.sent.one": "1 greska poslana u chat",
  "browser.console.findCause": "Pronadji uzrok i ispravi ga.",
}
