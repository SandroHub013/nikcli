export const dict = {
  ...
  "prompt.placeholder.normal": "ถามอะไรก็ได้ — / สำหรับคำสั่ง, @ สำหรับไฟล์และเอเจนต์",
  ...
  "session.tasks.title": "งาน",
  "command.session.rewind": "ย้อนกลับมาที่นี่",
  "command.transcript.verbosity": "สลับระดับรายละเอียด",
  "transcript.verbosity.compact": "กระชับ",
  "transcript.verbosity.normal": "ปกติ",
  "transcript.verbosity.verbose": "ละเอียด",
  "session.new.shortcuts.more": "กด {{keybind}} สำหรับคำสั่งอื่น",
  "command.browser.visualEditor": "เปิดตัวแก้ไขภาพ",
  "command.browser.visualEditor.description": "ตรวจสอบองค์ประกอบ แก้ไขสไตล์ และชี้สั่งงานเอเจนต์",
  "github.pr.branchMissing": "พุชแล้ว แต่ไม่พบ \"{{branch}}\" ใน {{repo}} — ที่เก็บนั้นน่าจะไม่ใช่ remote ของเช็คเอาต์นี้",
  "github.device.denied": "การอนุญาต GitHub ถูกปฏิเสธ",
  "github.device.expired": "รหัสอุปกรณ์หมดอายุแล้ว — เริ่มใหม่อีกครั้ง",
  "command.session.follow": "ติดตามเอเจนต์",
  "command.session.follow.on": "เปิด — ตัวแก้ไขจะเปิดทุกไฟล์ที่เอเจนต์แก้",
  "command.session.follow.off": "ปิด — ตัวแก้ไขจะอยู่ที่เดิม",
  "command.browser.designMode": "สลับโหมดออกแบบ",
  "command.browser.designMode.on": "เปิด — คลิกองค์ประกอบเพื่อตรวจสอบและแก้ไข",
  "command.browser.designMode.off": "ปิด — หน้าเว็บทำงานตามปกติ",
  "dialog.analytics.failed": "โหลดข้อมูลการใช้งานไม่สำเร็จ",
  "dialog.analytics.allTime": "ทั้งหมด",
  "terminal.sendToChat": "ส่งผลลัพธ์ไปที่แชท",
  "terminal.sendToChat.empty": "ไม่มีอะไรในเทอร์มินัลให้ส่ง",
  "terminal.sendToChat.done": "เพิ่มผลลัพธ์เทอร์มินัลลงในพรอมป์ตแล้ว",
  "terminal.sendToChat.description": "ส่งส่วนที่เลือก หรือบรรทัดท้ายของผลลัพธ์ ไปยังช่องพิมพ์",
  "session.queue.title": "{{count}} รอส่ง",
  "session.queue.steer": "ส่งเดี๋ยวนี้ เข้าสู่รอบที่กำลังทำงาน",
  "session.queue.steered": "ส่งเข้าสู่รอบที่กำลังทำงานแล้ว",
  "session.queue.steerFailed": "ส่งตอนนี้ไม่สำเร็จ",
  "session.queue.takeBack": "ดึงกลับไปที่ช่องพิมพ์",
  "session.queue.takeBackFailed": "ดึงกลับไม่สำเร็จ — อาจถูกส่งไปแล้ว",
  "session.queue.takeBackAll": "ดึงกลับทั้งหมด",
  "session.queue.takeBackPartial": "บางส่วนถูกส่งไปแล้วและดึงกลับไม่ได้",
  "command.session.exportMarkdown": "คัดลอกเซสชันเป็น Markdown",
  "command.session.exportMarkdown.description": "คำถามและคำตอบ พร้อมวางในอิชชูหรือรีวิว",
  "command.session.exportMarkdown.done": "คัดลอกแล้ว {{lines}} บรรทัด",
  "command.session.exportMarkdown.failed": "คัดลอกไปยังคลิปบอร์ดไม่สำเร็จ",
  "session.rewind.confirm": "ทิ้งรอบถัดไปและย้อนไฟล์กลับ",
  "session.usage.input": "อินพุต",
  "session.usage.output": "เอาต์พุต",
  "session.usage.reasoning": "การให้เหตุผล",
  "session.usage.cache": "การอ่านแคช",
  "session.usage.turns": "รอบ",
  "command.file.openExternal": "เปิดไฟล์ในตัวแก้ไขของคุณ",
  "command.file.openExternal.description": "ส่งไฟล์ที่เปิดอยู่ไปยัง VS Code, Cursor, Zed หรือ Windsurf",
  "command.file.openExternal.failed": "ไม่สามารถเปิดพาธนี้ภายนอกได้",
  "command.agent.planToggle": "โหมดวางแผน",
  "command.agent.planToggle.toPlan": "สลับไปโหมดวางแผน: สำรวจและเขียนแผน แต่แก้ไขไม่ได้",
  "command.agent.planToggle.toBuild": "กลับไปโหมดสร้าง",
  "command.agent.planToggle.on": "เปิดโหมดวางแผน ห้ามแก้ไข",
  "command.agent.planToggle.off": "เปิดโหมดสร้าง",
  "command.agent.planToggle.missing": "โปรเจกต์นี้ไม่มีเอเจนต์วางแผน",
  "session.queue.title.one": "1 รอส่ง",
  "command.session.exportMarkdown.done.one": "คัดลอกแล้ว 1 บรรทัด",
  "browser.console.sendAll": "ส่งทั้งหมดไปที่แชท",
  "browser.console.sent": "ส่งข้อผิดพลาด {{count}} รายการ",
  "browser.console.sent.one": "ส่งข้อผิดพลาด 1 รายการ",
  "browser.console.findCause": "หาสาเหตุและแก้ไข",
}
