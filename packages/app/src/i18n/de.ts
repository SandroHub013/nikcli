...
export const dict = {
  ...
  "prompt.placeholder.normal": "Frag alles — / für Befehle, @ für Dateien und Agenten",
  ...
  "session.tasks.title": "Aufgaben",
  "command.session.rewind": "Hierhin zurückspulen",
  "command.transcript.verbosity": "Detailgrad umschalten",
  "transcript.verbosity.compact": "Kompakt",
  "transcript.verbosity.normal": "Normal",
  "transcript.verbosity.verbose": "Ausführlich",
  "session.new.shortcuts.more": "{{keybind}} für alles Weitere",
  "command.browser.visualEditor": "Visuellen Editor öffnen",
  "command.browser.visualEditor.description": "Elemente prüfen, Styles bearbeiten und den Agenten gezielt beauftragen",
  "github.pr.branchMissing": "Push ausgeführt, aber \"{{branch}}\" ist nicht auf {{repo}} — dieses Repository ist vermutlich nicht das Remote dieses Checkouts.",
  "github.device.denied": "GitHub-Autorisierung abgelehnt",
  "github.device.expired": "Der Gerätecode ist abgelaufen — bitte erneut starten",
  "command.session.follow": "Dem Agenten folgen",
  "command.session.follow.on": "An — der Editor öffnet jede Datei, die der Agent bearbeitet",
  "command.session.follow.off": "Aus — der Editor bleibt, wo du ihn gelassen hast",
  "command.browser.designMode": "Design-Modus umschalten",
  "command.browser.designMode.on": "An — Elemente anklicken, um sie zu prüfen und zu bearbeiten",
  "command.browser.designMode.off": "Aus — die Seite verhält sich normal",
  "dialog.analytics.failed": "Nutzungsdaten konnten nicht geladen werden",
  "dialog.analytics.allTime": "gesamt",
  "terminal.sendToChat": "Ausgabe an den Chat senden",
  "terminal.sendToChat.empty": "Im Terminal gibt es nichts zu senden",
  "terminal.sendToChat.done": "Terminal-Ausgabe zum Prompt hinzugefügt",
  "terminal.sendToChat.description": "Sendet die Auswahl oder die letzten Ausgabezeilen an das Eingabefeld",
  "session.queue.title": "{{count}} wartet auf Versand",
  "session.queue.steer": "Jetzt senden, in den laufenden Zug",
  "session.queue.steered": "In den laufenden Zug gesendet",
  "session.queue.steerFailed": "Konnte jetzt nicht gesendet werden",
  "session.queue.takeBack": "Zurück in das Eingabefeld holen",
  "session.queue.takeBackFailed": "Konnte nicht zurückgeholt werden — es wurde vielleicht schon gesendet",
  "session.queue.takeBackAll": "Alle zurückholen",
  "session.queue.takeBackPartial": "Einige waren schon gesendet und kamen nicht zurück",
  "command.session.exportMarkdown": "Sitzung als Markdown kopieren",
  "command.session.exportMarkdown.description": "Fragen und Antworten, bereit zum Einfügen in ein Ticket oder Review",
  "command.session.exportMarkdown.done": "{{lines}} Zeilen kopiert",
  "command.session.exportMarkdown.failed": "Konnte nicht in die Zwischenablage kopiert werden",
  "session.rewind.confirm": "Verwirft die folgenden Züge und setzt die Dateien zurück",
  "session.usage.input": "Eingabe",
  "session.usage.output": "Ausgabe",
  "session.usage.reasoning": "Reasoning",
  "session.usage.cache": "Cache-Lesevorgänge",
  "session.usage.turns": "Züge",
  "command.file.openExternal": "Datei im Editor öffnen",
  "command.file.openExternal.description": "Übergibt die offene Datei an VS Code, Cursor, Zed oder Windsurf",
  "command.file.openExternal.failed": "Dieser Pfad lässt sich extern nicht öffnen",
  "command.agent.planToggle": "Planungsmodus",
  "command.agent.planToggle.toPlan": "Zum Planen wechseln: erkundet und schreibt einen Plan, bearbeitet aber nicht",
  "command.agent.planToggle.toBuild": "Zurueck zum Bauen",
  "command.agent.planToggle.on": "Planungsmodus an, Aenderungen gesperrt",
  "command.agent.planToggle.off": "Bau-Modus an",
  "command.agent.planToggle.missing": "Fuer dieses Projekt ist kein Plan-Agent konfiguriert",
  "session.queue.title.one": "1 wartet auf Versand",
  "command.session.exportMarkdown.done.one": "1 Zeile kopiert",
  "browser.console.sendAll": "Alle an den Chat senden",
  "browser.console.sent": "{{count}} Fehler an den Chat gesendet",
  "browser.console.sent.one": "1 Fehler an den Chat gesendet",
  "browser.console.findCause": "Finde die Ursache und behebe sie.",
