...
export const dict = {
  ...
  "prompt.placeholder.normal": "问任何问题 — / 调用命令，@ 引用文件和智能体",
  ...
  "session.tasks.title": "任务",
  "command.session.rewind": "回退到此处",
  "command.transcript.verbosity": "切换记录详细程度",
  "transcript.verbosity.compact": "精简",
  "transcript.verbosity.normal": "标准",
  "transcript.verbosity.verbose": "详细",
  "session.new.shortcuts.more": "按 {{keybind}} 查看其他命令",
  "command.browser.visualEditor": "打开可视化编辑器",
  "command.browser.visualEditor.description": "检查元素、编辑样式，并指向元素向智能体下达指令",
  "github.pr.branchMissing": "已推送，但 \"{{branch}}\" 不在 {{repo}} 中 — 该仓库可能不是此检出的远程仓库。",
  "github.device.denied": "GitHub 授权被拒绝",
  "github.device.expired": "设备代码已过期 — 请重新开始",
  "command.session.follow": "跟随智能体",
  "command.session.follow.on": "已开启 — 编辑器会打开智能体正在修改的文件",
  "command.session.follow.off": "已关闭 — 编辑器停留在你打开的位置",
  "command.browser.designMode": "切换设计模式",
  "command.browser.designMode.on": "已开启 — 点击元素即可检查和编辑",
  "command.browser.designMode.off": "已关闭 — 页面正常运行",
  "dialog.analytics.failed": "无法加载使用数据",
  "dialog.analytics.allTime": "全部时间",
  "terminal.sendToChat": "将输出发送到对话",
  "terminal.sendToChat.empty": "终端里没有可发送的内容",
  "terminal.sendToChat.done": "终端输出已加入提示",
  "terminal.sendToChat.description": "将选中内容或输出的最后几行发送到输入框",
  "session.queue.title": "{{count}} 条等待发送",
  "session.queue.steer": "立即发送到正在进行的回合",
  "session.queue.steered": "已发送到正在进行的回合",
  "session.queue.steerFailed": "现在无法发送",
  "session.queue.takeBack": "取回到输入框",
  "session.queue.takeBackFailed": "无法取回 — 可能已经发送",
  "session.queue.takeBackAll": "全部取回",
  "session.queue.takeBackPartial": "部分已发送，无法取回",
  "command.session.exportMarkdown": "将会话复制为 Markdown",
  "command.session.exportMarkdown.description": "问答内容，可直接粘贴到 issue 或评审中",
  "command.session.exportMarkdown.done": "已复制 {{lines}} 行",
  "command.session.exportMarkdown.failed": "无法复制到剪贴板",
  "session.rewind.confirm": "丢弃之后的回合并回退文件",
  "session.usage.input": "输入",
  "session.usage.output": "输出",
  "session.usage.reasoning": "推理",
  "session.usage.cache": "缓存读取",
  "session.usage.turns": "回合",
  "command.file.openExternal": "在你的编辑器中打开文件",
  "command.file.openExternal.description": "把当前文件交给 VS Code、Cursor、Zed 或 Windsurf",
  "command.file.openExternal.failed": "该路径无法在外部打开",
  "command.agent.planToggle": "计划模式",
  "command.agent.planToggle.toPlan": "切换到计划：只探索和写计划，不修改代码",
  "command.agent.planToggle.toBuild": "切回构建",
  "command.agent.planToggle.on": "计划模式已开启，禁止修改",
  "command.agent.planToggle.off": "构建模式已开启",
  "command.agent.planToggle.missing": "该项目未配置计划智能体",
  "session.queue.title.one": "1 条等待发送",
  "command.session.exportMarkdown.done.one": "已复制 1 行",
  "browser.console.sendAll": "全部发送到对话",
  "browser.console.sent": "已发送 {{count}} 个错误",
  "browser.console.sent.one": "已发送 1 个错误",
  "browser.console.findCause": "找出原因并修复。",
