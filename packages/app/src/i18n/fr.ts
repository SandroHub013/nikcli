export const dict = {
  ...
  "prompt.placeholder.normal": "Demandez ce que vous voulez — / pour les commandes, @ pour les fichiers et agents",
  ...
  "session.tasks.title": "Tâches",
  "command.session.rewind": "Revenir ici",
  "command.transcript.verbosity": "Changer le niveau de détail",
  "transcript.verbosity.compact": "Compact",
  "transcript.verbosity.normal": "Normal",
  "transcript.verbosity.verbose": "Détaillé",
  "session.new.shortcuts.more": "Appuyez sur {{keybind}} pour tout le reste",
  "command.browser.visualEditor": "Ouvrir l'éditeur visuel",
  "command.browser.visualEditor.description": "Inspectez les éléments, modifiez les styles et guidez l'agent",
  "github.pr.branchMissing": "Push effectué, mais \"{{branch}}\" n'est pas sur {{repo}} : ce dépôt n'est probablement pas le distant de cette copie.",
  "github.device.denied": "Autorisation GitHub refusée",
  "github.device.expired": "Le code d'appareil a expiré — recommencez",
  "command.session.follow": "Suivre l'agent",
  "command.session.follow.on": "Activé : l'éditeur ouvre chaque fichier modifié par l'agent",
  "command.session.follow.off": "Désactivé : l'éditeur reste où vous l'avez laissé",
  "command.browser.designMode": "Basculer le mode design",
  "command.browser.designMode.on": "Activé : cliquez sur les éléments pour les inspecter et les modifier",
  "command.browser.designMode.off": "Désactivé : la page se comporte normalement",
  "dialog.analytics.failed": "Impossible de charger les données d'utilisation",
  "dialog.analytics.allTime": "depuis toujours",
  "terminal.sendToChat": "Envoyer la sortie au chat",
  "terminal.sendToChat.empty": "Rien à envoyer dans le terminal",
  "terminal.sendToChat.done": "Sortie du terminal ajoutée au prompt",
  "terminal.sendToChat.description": "Envoie la sélection, ou les dernières lignes de sortie, au champ de saisie",
  "session.queue.title": "{{count}} en attente d'envoi",
  "session.queue.steer": "Envoyer maintenant, dans le tour en cours",
  "session.queue.steered": "Envoyé dans le tour en cours",
  "session.queue.steerFailed": "Impossible de l'envoyer maintenant",
  "session.queue.takeBack": "Le récupérer dans la zone de saisie",
  "session.queue.takeBackFailed": "Impossible de le récupérer : il a peut-être déjà été envoyé",
  "session.queue.takeBackAll": "Tout récupérer",
  "session.queue.takeBackPartial": "Certains avaient déjà été envoyés et n'ont pas pu revenir",
  "command.session.exportMarkdown": "Copier la session en Markdown",
  "command.session.exportMarkdown.description": "Questions et réponses, prêtes à coller dans un ticket ou une revue",
  "command.session.exportMarkdown.done": "{{lines}} lignes copiées",
  "command.session.exportMarkdown.failed": "Impossible de copier dans le presse-papiers",
  "session.rewind.confirm": "Supprime les tours suivants et rétablit les fichiers",
  "session.usage.input": "Entrée",
  "session.usage.output": "Sortie",
  "session.usage.reasoning": "Raisonnement",
  "session.usage.cache": "Lectures de cache",
  "session.usage.turns": "Tours",
  "command.file.openExternal": "Ouvrir le fichier dans votre éditeur",
  "command.file.openExternal.description": "Transmet le fichier ouvert à VS Code, Cursor, Zed ou Windsurf",
  "command.file.openExternal.failed": "Ce chemin ne peut pas être ouvert à l'extérieur",
  "command.agent.planToggle": "Mode plan",
  "command.agent.planToggle.toPlan": "Passer en planification : explore et redige un plan, sans pouvoir editer",
  "command.agent.planToggle.toBuild": "Revenir a la construction",
  "command.agent.planToggle.on": "Mode plan active, modifications bloquees",
  "command.agent.planToggle.off": "Mode construction active",
  "command.agent.planToggle.missing": "Ce projet na pas dagent de planification configure",
  "session.queue.title.one": "1 en attente denvoi",
  "command.session.exportMarkdown.done.one": "1 ligne copiee",
  "browser.console.sendAll": "Tout envoyer au chat",
  "browser.console.sent": "{{count}} erreurs envoyees au chat",
  "browser.console.sent.one": "1 erreur envoyee au chat",
  "browser.console.findCause": "Trouve la cause et corrige-la.",
}
