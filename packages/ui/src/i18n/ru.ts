export const dict = {
  ...
  "ui.artifactPreview.copyLink": "Скопировать ссылку",
  "ui.artifactPreview.openInBrowser": "Открыть в браузере",

  "ui.tool.read": "Чтение",
  "ui.tool.artifact": "Артефакт",
  ...
  "ui.messagePart.revertEdit": "Отменить, начиная отсюда",
}
