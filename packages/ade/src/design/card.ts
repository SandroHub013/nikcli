/**
 * What the answer buttons of a design card show and do.
 *
...
export function discardedBadge(discarded: number): string | undefined {
  return discarded > 0 ? t("design.badge.discarded", discarded) : undefined
}

/** «· N in coda» on the bar button, or nothing. */
export function queuedBadge(queued: number): string | undefined {
  return queued > 0 ? t("design.badge.queued", queued) : undefined
}
