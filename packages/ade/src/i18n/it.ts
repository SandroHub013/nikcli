...
export const it = {
  ...
  "voice.alwaysListening": (wakeWord: string) => `Da questa versione ADE ascolta sempre e l'assistente risponde solo quando dici «${wakeWord}». Per non farlo ascoltare da solo scegli «Solo quando lo apri» qui sotto; per il microfono aperto che risponde a tutto, «Acceso e spento».`,
