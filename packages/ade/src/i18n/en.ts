...
export const en: Messages = {
  ...
  "palette.design.open": "Design proposals for you",
  "palette.design.pane": "Open Design panel",
  ...
  "newPane.design.hint": "UI proposals, variants and previews",
  ...
  "update.acting": "Updating…",
  "update.downloading": (done, total) => (total ? `Downloading ${done} of ${total} MB` : `Downloading ${done} MB`),
  "update.installing": "Installing: ADE closes and reopens by itself.",
  "update.restart.none": "ADE closes and reopens by itself. No session is running.",
  "update.dialog.starting": "Downloading the new version…",
  "update.dialog.failed": "Couldn’t download the new version. Your sessions were not touched.",
  "update.dialog.notes": (version) => `Everything new in ${version}`,
  ...
  "file.showText": "Show the text",
  "file.binary": (error) => `${error}: ADE has no viewer for this format`,
  "file.imageFailed": "image not readable",
  "file.fontFailed": "font not readable",
  "file.fontSample": "The quick brown fox jumps over the lazy dog",
  "file.audioFailed": "audio format not supported by this WebView",
  ...
  "activity.folderGone": "Folder gone",
  ...
  "pane.suspend": "Suspend",
  "pane.suspend.tip": "Closes the session's processes and keeps its conversation: resume it from here",
  "pane.suspend.no": (why) => `Suspend unavailable: ${why}`,
  "palette.session.suspend": "Suspend the session",
  "suspend.why.notClaude": "only Claude sessions can be suspended",
  "suspend.why.suspended": "it is already suspended",
  "suspend.why.notRunning": "it has no live process",
  "suspend.why.noConversation": "the conversation is not on disk: resuming would open a new one",
  "suspend.why.working": "it is working",
  "suspend.why.permission": "it has a permission prompt open",
  "suspend.why.requestTo": "it has an open request to answer",
  "suspend.why.requestFrom": "it is waiting for a reply",
  ...
  "project.missing": (root) => `The folder ${root} no longer exists.`,
  "project.missing.remove": "Remove from the list",
  "project.missing.badge": "gone",
  "project.missing.tip": (root) => `The folder ${root} no longer exists`,
  "palette.recent.missing": (root) => `Folder gone · ${root}`,
  "note.suspended": "Session suspended: processes closed, conversation saved. Resume to continue.",
  ...
  "browser.design.addToNote": "Add to the note",
  "browser.design.added": "Added to the proposal's note.",
  "browser.design.prompt": "What to change here? (optional)",
  "browser.design.pick": "I pick this one",
  "browser.design.picked": "Picked",
  "browser.design.previous": "Previous variant",
  "browser.design.next": "Next variant",
  ...
  "decisions.multi": "you can pick more than one",
  ...
  "design.keeps": "Stays as it is",
  "design.variant.changes": "What changes",
  "design.variant.openLarge": "Open large",
  ...
  "design.submitNext": "Record and next",
  "design.noProject": "No project open.",
  "design.noProject.hint": "The design log lives in the project's .ade/design.jsonl.",
  "design.unreadable": (problem) => `Can't read the log: ${problem}`,
  "design.ignored": (count) => `${count === 1 ? "1 line" : `${count} lines`} skipped in the log`,
  "design.section.open": "Design proposals, in order",
  "design.section.answered": "Answered, waiting to be carried out",
  "design.section.closed": (count) => `Closed · ${count}`,
  "design.none": "No open design proposals.",
  "design.pill.open": "open",
  "design.pill.answered": "chosen",
  ...
  "design.recipient": "Send answers to",
  ...
  "design.sheet.needChoice": "Nothing chosen: press 1–9 or click an option, then Enter",
  ...
  "design.multi": "you can pick more than one",
  ...
  "note.viaNative": (name) => `Native delivery: the sender sends it with SendMessage to session "${name}"`,
  "note.viaTyped": (reason) => `Typed delivery (${reason})`,
  "note.viaNativeAck": () => `Native delivery confirmed`,
  "note.viaFallback": (reason) => `Native delivery not confirmed (${reason}): ADE types it`,
  ...
  "decisions.log.multi": "a multiple choice needs at least two options",
  "decisions.log.choices": "choices not a list, empty or repeated",
  "decisions.log.choiceAndChoices": "choice and choices together",
  "decisions.rule.multiChoice": (key) => `${key} is multiple choice: answer with choices`,
  "decisions.rule.unknownChoice": (key) => `${key}: one of the choices is not an option`,
  "decisions.rule.singleChoice": (key) => `${key} is not multiple choice: choices does not apply`,
  ...
  "decisions.log.facts": "facts isn't a list of texts",
  "decisions.log.recommend": "recommend needs { option, because }",
  "decisions.log.recommendOption": (option) => `the recommendation "${option}" isn't one of the options`,
  "decisions.log.contextNeeded": "the new fields need a context too: builds that don't know them show only that",
  ...
  "design.log.json": "invalid JSON",
  "design.log.invalid": (reason) => `invalid event: ${reason}`,
  "design.log.notObject": "not an object",
  "design.log.type": "unknown type",
  "design.log.key": "missing or invalid key",
  "design.log.date": "missing or invalid date",
  "design.log.author": "missing author",
  "design.log.title": "missing title",
  "design.log.order": "order isn't a number",
  "design.log.words": "answer without the user's words",
  "design.log.multi": "a multiple choice needs at least two variants",
  "design.log.choices": "choices not a list, empty or repeated",
  "design.log.choiceAndChoices": "choice and choices together",
  "design.rule.multiChoice": (key) => `${key} is multiple choice: answer with choices`,
  "design.rule.unknownChoice": (key) => `${key}: one of the choices is not a variant`,
  "design.rule.singleChoice": (key) => `${key} is not multiple choice: choices does not apply`,
  "design.log.variants": "missing or invalid variants",
  "design.log.variantName": "variant without a name",
  "design.log.changes": "changes isn't a list of texts",
  "design.log.keeps": "keeps isn't a list of texts",
  "design.log.recommend": "recommend needs { option, because }",
  "design.log.recommendOption": (option) => `the recommendation "${option}" isn't one of the variants`,
  "design.log.contextNeeded": "the new fields need a context too: builds that don't know them show only that",
  "design.log.tooLarge": (mb) => `the design log is larger than ${mb} MB`,
  "design.rule.exists": (key) => `${key} already exists`,
  ...
  "design.problem.line": (line, reason) => `line ${line}: ${reason}`,
