...
export const en: Messages = {
  ...
  "chat.needKey": "Needs an OpenRouter key.",
  ...
  "bots.stop": "Stop",
  "bots.mention.switch": (name) => `Hand message over to ${name}`,
  ...
  "bots.tokens": (count) => `${count} tokens`,
  "bots.send": "Send",
  ...
  "bots.card.messages": (count) => `${count} messages`,
