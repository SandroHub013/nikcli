 ...
 */
export function terminalRendersHalfBlockQR(env: NodeJS.Dict<string> = process.env) {
 ...
 */
export function shouldUseAsciiQR(platform: NodeJS.Platform = process.platform, env: NodeJS.Dict<string> = process.env) {
